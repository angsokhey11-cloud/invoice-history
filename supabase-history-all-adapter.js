...
(function(){
  ...
  async function fetchApi(params={}){
    ...
    if(action==='invoiceDetail')return rpc('bb_invoice_history_all_detail',{p_invoice_no:String(params.invoiceNo||'')});
  ...
  window.BBHistoryAllAdapter={rpc,fetchApi,historyJsonp,postHistoryAction,requirePrimaryAdmin,ensureSession};
})();
